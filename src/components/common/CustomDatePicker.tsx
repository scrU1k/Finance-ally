  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      {isOpen && (
        ...
        >
          <div
            className="dotgui-glass border border-hairline rounded-2xl shadow-2xl p-4 space-y-3 animate-in fade-in zoom-in-95 duration-100 bg-surface-card/95 backdrop-blur-xl w-72 max-w-[92vw]"
