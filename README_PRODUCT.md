...
> **Your Money. Your Vault. Zero Cloud. Total Control.**
...
- **🔒 100% Offline & Private**: All your financial logs, trip budgets, and notes stay sandboxed on your device. No signup required, no cloud tracking, no hidden data sales.
...
- **✈️ Foreign Trip Vaults**: Planning a vacation abroad? Create dedicated trip vaults to track domestic & international travel spending in local currencies without cluttering your daily home budget.
- **🍕 Split Bills & Share Formats**: Easily split group meals and trips with friends. Calculate tips/taxes, toggle who has paid or owes, and generate formatted text summaries to copy or send to your friends.
- **📊 Monthly Financial Audits**: Get intelligent month-end financial reviews with automated letter grades (A+ to F), anomaly warnings, top category breakdowns, and personalized actionable savings suggestions.
...
Forget tedious multi-step form fields. Type or paste your expenses naturally into the Quick Log bar:
- **Flexible Time Parsing**: Understood in any format — `8pm`, `8.30 pm`, `8-30pm`, `08:00`, `morning`, `afternoon`, `night`, or `now`.
- **Exhaustive Date Detection**: Recognizes `2nd August`, `aug 2`, `02/08/2026`, `yesterday`, `today`, or weekdays like `Wednesday`.
- **Auto Multi-Currency Recognition**: Automatically handles `₹`, `Rs`, `Rupees`, `$`, `USD`, `€`, `EUR`, `£`, `GBP`, `¥`, `JPY`.
- **Auto-Categorization**: Intelligent category detection for Food, Groceries, Transport, Electronics, Clothing, Housing, Entertainment, Health, and Investments.
- **Interactive Tag Selector**: Click any auto-assigned category tag in the preview card to switch it before logging.
...
- **Auto-Log My Share**: Instantly log your personal portion into your main daily expense timeline with a single tap.

---

### 5. 📊 Interactive Daily Timeline & Spending Trends
- **Day & Period Views**: Toggle between Day, Week, Month, Year, and All-Time spending summaries.
- **Daily Spending Chart**: Tap the "Spending Trend" header to dynamically switch between smooth line charts and detailed bar graphs.
- **Minimized Floating Pill**: Collapse the bottom summary bar into a floating glassmorphic pill showing your total period spending without taking up screen space.
...
- **Actionable Advice**: Tailored suggestions on where you can optimize subscriptions or cut unnecessary costs.
